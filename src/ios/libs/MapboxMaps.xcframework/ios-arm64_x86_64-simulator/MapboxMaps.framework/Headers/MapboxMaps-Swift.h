...
SWIFT_CLASS("_TtC10MapboxMaps7MapView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC10MapboxMaps16OrnamentsManager") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
